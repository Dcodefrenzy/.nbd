<?php
$page_title = "Global News - BoardSpeck";
$page_name = "news";
          ...
          <div class="composs-panel-inner">
            ...
            <div class="composs-blog-list lets-do-1">
              ...
              <div class="item">
                <div class="item-header">
                  <a href="#" class="img-read-later-button">Read later</a>
                  <a href="post.php"><img src="images/photos/image-12.jpg" alt="" /></a>
                </div>
                <div class="item-content">
              ...
              <div class="item">
                <div class="item-header">
                  <a href="#" class="img-read-later-button">Read later</a>
                  <a href="post.php"><img src="images/photos/image-14.jpg" alt="" /></a>
                </div>
                <div class="item-content">
                  <h2><a href="post.html">Horror Icon Angus Scrimm Passes Away; The Tall Man Remains Immortal</a></h2>
                  <span class="item-meta">
              ...
              $statement = $conn->prepare("SELECT * FROM news WHERE visibility = :sh AND category=:cat");
              ...
              getPaginatedAfrica($conn,$offset,$perPage, 'Global') ?>
