...
<?php
	if($page_name == "home"){
			...
			<meta property="og:description" content=" BoardSpeck is an emerging news and information platform, out to provide information to people of different, region, beliefs, cadres and status. " />';
				...
				<nav class="header-top">
					...
					<div class="header-content">
						...
						<div class="header-content-logo">
							<a href="#"><img src="images/logo4.png" width="200" height="100"  alt="" /></a>
						</div>
